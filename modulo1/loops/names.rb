# Crie um loop onde exista a pergunta se o usuário quer adicionar novos membros na equipe até que o usuário responda não, 
# caso sim, permita o usuário inserir o nome.
